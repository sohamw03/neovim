...
require('lazy').setup({
  ...
  --     }
  --
  --     -- Tab kepmap for accepting suggestions
...

  {
    ...
    opts = {
      ...
      completion = {
        documentation = {
          auto_show = true, -- Enable docs popup automatically on selection
          auto_show_delay_ms = 0, -- Show delay (in ms), adjust as you like
        },
      },
      keymap = {
        preset = 'default',
        ...
        ['<C-n>'] = { 'select_next' }, -- Ctrl-n for next item
        ['<C-p>'] = { 'select_prev' }, -- Ctrl-p for previous item
        ['<C-Space>'] = { 'show' }, -- Ctrl-Space to trigger completion
      },
    },
    event = 'InsertEnter',
  },
